 ...
 */
export function ring(innerRadius = 0.25, outerRadius = -1, slices = 32) {
    if (outerRadius < 0) {
 ...
 */
export function uvSphere(radius = 0.5, slices = 32, stacks = 16) {
...
//# sourceMappingURL=basic-object-models-IFS.js.map