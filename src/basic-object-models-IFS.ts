// Based on a file of similar name in David Eck's 
 ...
 */
  ...
  */
 export function cube(side = 1): IFSMesh {
    var s = side/2;
    var coords = Array<number>();
    var normals = Array<number>();
    var texCoords = Array<number>();
    var indices = Array<number>();
    function face(xyz: Array<number>, nrm: Array<number>) {
  ...
  */
 export function ring(innerRadius = 0.25, outerRadius = -1, slices = 32): IFSMesh {
    if (outerRadius < 0) {
  ...
  */
 export function uvSphere(radius = 0.5, slices = 32, stacks = 16): IFSMesh {
  ...
  */
 export function uvTorus(outerRadius = 0.5, innerRadius = -1, slices = 32, stacks = 16) {
    if (innerRadius < 0) {
  ...
  */
 export function uvCylinder(radius = 0.5, height = -1, slices = 32, noTop = false, noBottom = false) {
    if (height < 0) {
        height = 2*radius;
    }
  ...
  */
 export function uvCone(radius = 0.5, height = -1, slices = 32, noBottom = false) {
    if (height < 0) {
        height = 2*radius;
    }
