...
// Keep all the pointers to the Shader parameters in one place
interface ShaderData {
    ...
    u_lightAttC0: WebGLUniformLocation | null;
    u_lightAttC1: WebGLUniformLocation | null;
    u_lightAttC2: WebGLUniformLocation | null;

    u_lightCount: WebGLUniformLocation | null;
    u_lightPosition: Array<WebGLUniformLocation | null>;
    u_lightColor:  Array<WebGLUniformLocation | null>;
    u_lightIntensity:  Array<WebGLUniformLocation | null>;

    u_useTexture: WebGLUniformLocation | null;
    u_texture: WebGLUniformLocation | null;

    u_diffuseColor: WebGLUniformLocation | null;
    u_ambientK: WebGLUniformLocation | null;
    u_diffuseK: WebGLUniformLocation | null;
    u_specularK: WebGLUniformLocation | null;
    u_specularExponent: WebGLUniformLocation | null;
}
...
export class Drawable extends Thing {
    ...
    // internal GL resources that will be passed to shader
...
export class Light extends Thing {
    ...
    setup(gl: WebGLRenderingContext, sd: ShaderData, lightnumber: number, p: Vector) {
